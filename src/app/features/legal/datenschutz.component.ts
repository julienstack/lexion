    ...
    template: `
        <div class="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800">
            <div class="max-w-4xl mx-auto px-6 py-16">
                ...
                <h1 class="text-4xl font-bold text-white mb-8">Datenschutzerklärung</h1>
                
                <div class="prose prose-invert max-w-none space-y-8">
                    
                    <section>
                        <h2 class="text-2xl font-semibold text-white mb-4">1. Datenschutz auf einen Blick</h2>
                        
                        <h3 class="text-xl font-medium text-white mt-6 mb-3">Allgemeine Hinweise</h3>
                        ...
                        <h3 class="text-xl font-medium text-white mt-6 mb-3">Datenerfassung auf dieser Website</h3>
                    ...
                    <section>
                        <h2 class="text-2xl font-semibold text-white mb-4">2. Hosting</h2>
                        <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700/50">
                            <p class="text-gray-400 leading-relaxed">
                                Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
                            </p>
                            <p class="text-gray-300 mt-4">
                                <strong class="text-white">Externes Hosting</strong><br>
                    ...
                    <section>
                        <h2 class="text-2xl font-semibold text-white mb-4">3. Allgemeine Hinweise und Pflichtinformationen</h2>
                        
                        <h3 class="text-xl font-medium text-white mt-6 mb-3">Datenschutz</h3>
                        <p class="text-gray-400 leading-relaxed">
                        ...
                        <h3 class="text-xl font-medium text-white mt-6 mb-3">Hinweis zur verantwortlichen Stelle</h3>
                        <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700/50 mt-4">
                    ...
                    <section>
                        <h2 class="text-2xl font-semibold text-white mb-4">4. Datenerfassung auf dieser Website</h2>
                        
                        <h3 class="text-xl font-medium text-white mt-6 mb-3">Cookies</h3>
                        <p class="text-gray-400 leading-relaxed">
                        ...
                        <h3 class="text-xl font-medium text-white mt-6 mb-3">Server-Log-Dateien</h3>
                        <p class="text-gray-400 leading-relaxed">
                        ...
                        <h3 class="text-xl font-medium text-white mt-6 mb-3">Registrierung auf dieser Website</h3>
                        <p class="text-gray-400 leading-relaxed">
                    ...
                    <section>
                        <h2 class="text-2xl font-semibold text-white mb-4">5. Ihre Rechte</h2>
                        
                        <div class="grid gap-4 mt-6">
                            <div class="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50">
                                <h4 class="text-white font-medium mb-2">Recht auf Auskunft</h4>
                            ...
                            <div class="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50">
                                <h4 class="text-white font-medium mb-2">Recht auf Berichtigung</h4>
                                <p class="text-gray-400 text-sm">
                                    Sie haben das Recht, die Berichtigung unrichtiger personenbezogener Daten zu verlangen.
                                </p>
                            </div>
                            <div class="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50">
                                <h4 class="text-white font-medium mb-2">Recht auf Löschung</h4>
                                <p class="text-gray-400 text-sm">
                            ...
                            <div class="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50">
                                <h4 class="text-white font-medium mb-2">Recht auf Datenübertragbarkeit</h4>
                                <p class="text-gray-400 text-sm">
                            ...
                            <div class="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50">
                                <h4 class="text-white font-medium mb-2">Widerspruchsrecht</h4>
                                <p class="text-gray-400 text-sm">
                    ...
                    <section>
                        <h2 class="text-2xl font-semibold text-white mb-4">6. Analyse-Tools und Werbung</h2>
